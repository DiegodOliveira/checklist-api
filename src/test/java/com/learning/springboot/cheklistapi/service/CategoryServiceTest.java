...
public class CategoryServiceTest {
    ...
    @Test
    public void shouldCreateACategorySucessfully(){
    ...
    public void shouldThrowAnExceptionWhenCategoryNameIsNullOrEmpty(){
        Exception exception = Assertions.assertThrows(IllegalArgumentException.class, () -> this.categoryService.addNewCategory(null));
    ...
    @Test
    public void shouldThrowAnExceptionWhenTryToUpdateAndCategoryGuidIsNullOrEmpty(){
        Exception exception = Assertions.assertThrows(IllegalArgumentException.class, () -> this.categoryService.updateCategory("", "Sample Name"));

        assertThat(exception.getMessage(), is("Invalid parameters provided to update a category"));
    }

    @Test
    public void shouldThrowAnExceptionWhenTryToUpdateAndCategoryAndNameIsNullOrEmpty(){
        Exception exception = Assertions.assertThrows(IllegalArgumentException.class, () -> this.categoryService.updateCategory("any value", ""));

        assertThat(exception.getMessage(), is("Invalid parameters provided to update a category"));
    }

    @Test
    public void shouldThrowAnExceptionWhenTryToUpdateAndCategoryAndItDoesNotExist(){

        when(categoryRepository.findByGuid(anyString())).thenReturn(Optional.empty());

        Exception exception = Assertions.assertThrows(ResourceNotFoundException.class, () -> this.categoryService.updateCategory("any value", "any name"));
